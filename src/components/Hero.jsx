  ...
  return (
    <section id="hero" ref={containerRef} className={`relative min-h-[90vh] flex flex-col justify-center overflow-hidden pb-6 bg-teal-light transition-all duration-500 ${bannerVisible ? 'pt-[170px]' : 'pt-[80px]'}`}>
      ...
      <div className="relative z-10 text-center px-6 max-w-[1200px] mx-auto w-full">
        ...
        <h1 className="hero-title text-[clamp(2.5rem,6vw,4.5rem)] text-secondary font-black max-w-[1000px] mx-auto mb-6 tracking-tight leading-[1.05]">
        ...
        <p className="hero-description text-secondary/80 text-lg md:text-2xl max-w-[800px] mx-auto mb-6 leading-relaxed font-medium">
        ...
        <p className="hero-badges text-secondary/50 text-[0.85rem] md:text-[1rem] max-w-[850px] mx-auto mb-8 leading-relaxed italic">
        ...
        <div className="hero-marquee relative overflow-hidden w-full opacity-40 hover:opacity-100 transition-opacity duration-500 mask-fade py-4">
